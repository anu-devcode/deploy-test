...
export declare class AnalyticsController {
    ...
    getRecentOrders(tenantId: string, limit?: string): Promise<({
        customer: {
            email: string;
    ...
    getSalesOverTime(tenantId: string, days?: string): Promise<{
        date: string;
        total: number;
    }[]>;
    getTopProducts(tenantId: string, limit?: string): Promise<{
        product: {
            name: string;
            id: string;
            price: import("@prisma/client-runtime-utils").Decimal;
